...
class free_space_navigation():
 ...
 # @parameter speed: represents the speed of the robot the robot
 # @parameter distance: represents the distance to move by the robot
 # @parameter isForward: if True, the robot moves forward,otherwise, it moves backward
 #
 # Method 1: using tf and Calculate the distance between the two transformations
    ...
    def move_v1(self, speed, distance, isForward):
     ...
     # It is important to "waitForTransform" otherwise, it might not be captured.
        ...
        while True :
            rospy.loginfo("Turtlebot moves forwar)
