...
def go_to_goal(velocity_publisher, x_goal, y_goal):
    ...
    while (True):
        K_linear = 0.5 #ifvalue is high, it will oscillate, bcoz gain is very high
...
def setDesiredOrientation(publisher, speed_in_degree, desired_angle_degree): #not some rot, desired rot sngle it is
